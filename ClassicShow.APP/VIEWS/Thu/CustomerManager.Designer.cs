namespace ClassicShow.APP.VIEWS
{
    partial class CustomerManager
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.Location = new Point(70, 249);
            ...
            label4.Location = new Point(70, 314);
            ...
            label5.Location = new Point(802, 116);
            ...
            label6.Location = new Point(74, 382);
            ...
            label7.Location = new Point(802, 181);
            ...
            label8.Location = new Point(802, 314);
            ...
            btn_hthi.Text = "Hiển thị";
            btn_hthi.UseVisualStyleBackColor = true;
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.Location = new Point(802, 244);
            ...
            label10.Location = new Point(802, 382);
            label10.Margin = new Padding(2, 0, 2, 0);
            label10.Name = "label10";
            label10.Size = new Size(101, 20);
            label10.TabIndex = 23;
            label10.Text = "Mức giảm giá";
            // 
            // txt_giamgia
            // 
            ...
            label11.Location = new Point(540, 9);
            label11.Name = "label11";
            label11.Size = new Size(378, 46);
            label11.TabIndex = 28;
            label11.Text = "Quản lí khách hàng";
            // 
            // CustomerManager
            // 
            ...
            Controls.Add(txt_giamgia);
            Controls.Add(label10);
            Controls.Add(cbx_loaikh);
            Controls.Add(label9);
            Controls.Add(btn_hthi);
            Controls.Add(txt_diem);
            Controls.Add(label8);
            Controls.Add(btn_xoa);
            Controls.Add(btn_sua);
            Controls.Add(btn_them);
            Controls.Add(dtp_ngsinh);
            Controls.Add(rdb_nu);
        ...
        private DateTimePicker dtp_ngsinh;
        private Button btn_them;
        private Button btn_sua;
        private Button btn_xoa;
        private Label label8;
        private TextBox txt_diem;
        private Button btn_hthi;
